...
A command-line tool for [SWIYU](https://www.eid.admin.ch/) — the Swiss eID
infrastructure — to create, update, deactivate, and inspect DIDs against the
SWIYU Identifier Registry. Manages a local key store with the generated DIDs
and their key pairs.
...
[sample use case](./doc/sample-use-case.md): a small Swiss consulting
