...
use crate::test_support::fixtures::{SAMPLE_PARTNER_ID, SAMPLE_REGISTRY_UUID};
...
// Distinct from `crate::test_support::fixture_did`: this one threads
// SAMPLE_REGISTRY_UUID through the path so e2e tests can match the same UUID
// they see in allocate_path / publish_path / registry_url_in_response.
