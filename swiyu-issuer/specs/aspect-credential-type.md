...
2. **Registers an issuer `I1`** with display name *"Gemeindebibliothek Flawil"*, linked to Flawil's SWIYU Business Partner record and the DID covered by Flawil's Trust Statement. `I1` belongs to the Flawil tenant.
